...
mongoose.connect('mongodb://Gieryn:ag180889@ds117158.mlab.com:17158/1stdatabase' || process.env.MONGODB_URI);
...
// we can set our custom methods for schema
...
// pre-save method (save the date of saving/updating)
...
// end of schema-related declarations
...
// now we can use the schema above in a so called model
/* 
"Mongoose by default produces a collection name by passing the model name to the utils.toCollectionName method. 
This method pluralizes the name. Here, it will be collection named 'users'."
*/
